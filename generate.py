                ...
                "sub_steps": [
                    {
                        ...
                        "desc": "质量管理员在 Web 后端配置异常处理小组和资源黑名单。设定不良率区间与处理小组的对应关系（如不良率 0~5% → A组、5~10% → B组、10%以上 → C组）。同时维护资源黑名单，将休假、离职或不可用的人员排除，确保异常单不会指派给不恰当的人员。",
                        "remark": "不良率区间不能重叠，系统会自动校验区间范围。资源配置支持添加、删除、修改，修改后即时生效。",
                        "images": []
                    },
                    {
                    ...
                    {
                        "id": "4.3", "name": "未确认 → 指派异常单",
                        "desc": "第一群组人员在 H5 端【异常处置】模块→「未确认」页签中查看新发起的异常单。可编辑指派给对应的处理小组或处理人员，填写处理说明后提交。被指派人员收到通知后进行签收，异常单状态变更为「待处理」，进入处置环节。",
                        "remark": "未确认页签仅显示未指派的异常单。支持手动重新指派给其他小组。",
                        "images": []
                    },
                    {
                        "id": "4.4", "name": "待处理 → 处置对策录入",
                        "desc": "被指派小组在「待处理」页签查看异常单详情，在处置对策中填写具体的处理措施和方案，提交后进入待审批环节。",
                        "remark": "处置对策支持文字描述和附件上传。",
                        "images": []
                    },
                    {
                        "id": "4.5", "name": "待审批 → 主管签核",
                    ...
                    {
                        "id": "4.8", "name": "异常单自动升级",
                        "desc": "后端可配置异常单的超时升级规则。当异常单在某个环节超时未处理时，系统自动将异常单升级至上级处理。升级规则包括：环节超时时间设定、升级处理人指定、升级通知方式等。超时后系统自动推送通知给上级人员，确保异常不被遗漏。",
                        "remark": "自动升级机制确保异常单不会因为人员疏忽而长时间滞留。每升级一次系统自动记录升级日志。",
                        "images": []
                    }
                ]
            },
